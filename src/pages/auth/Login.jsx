        ...
        <div className="space-y-6">
          ...
          <form onSubmit={submit} className="space-y-4">
            ...
            <div className="space-y-3">
              <p className="text-sm text-muted-foreground">Chọn nhanh tài khoản demo:</p>
              <div className="flex flex-wrap gap-2">
                {TEST_ACCOUNTS.map((account) => (
                  <button
                    ...
                    className="px-3 py-1.5 rounded-full border border-border text-xs bg-muted text-muted-foreground hover:bg-accent hover:text-accent-foreground transition-colors"
                  >
                    {account.label}
                  </button>
                ))}
