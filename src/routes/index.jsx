...
          <Route path="provider/resources/:resourceId" element={<ResourceDetail />} />
          <Route path="provider/resources/:resourceId/view" element={<ResourceDetail />} />
            {/* Content & Assignment management routes */}
            <Route path="provider/resources/:resourceId/create-content" element={<CreateContent />} />
            <Route path="provider/resources/:resourceId/create-assignment" element={<CreateAssignment />} />

            <Route path="provider/resources/:resourceId/content/:contentId" element={<ContentDetailView />} />
            <Route path="provider/resources/:resourceId/content/:contentId/edit" element={<CreateContent />} />

            <Route path="provider/resources/:resourceId/assignment/:assignmentId" element={<AssignmentDetailView />} />
            <Route path="provider/resources/:resourceId/assignment/:assignmentId/edit" element={<CreateAssignment />} />

            {/* Resource edit placeholder (no dedicated edit page yet) - show detail for now */}
            <Route path="provider/resources/:resourceId/edit" element={<ResourceDetail />} />
          <Route
